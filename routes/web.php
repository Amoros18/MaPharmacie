...
Route::prefix('pharmacie/')->name('pharmacie.')->group(function(){
    ...
    Route::get('update/{table}', [PharmacieController::class,'updatePharmacie'])->name('update');
    Route::post('update/{table}', [PharmacieController::class,'update_pharmacie']);
    Route::get('delete/{table}',[PharmacieController::class,'deletePharmacie'])->name('delete');
...
Route::prefix('medicament')->name('medicament.')->group(function(){
    ...
    Route::get('delete{table}',[MedicamentController::class,'deleteMedicament'])->name('delete');
